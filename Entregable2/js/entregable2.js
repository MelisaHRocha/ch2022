...
function VerificarStorage(locacion){
    ...
    ArrayHabitacionesJson.length > 0 &&  
     ...
     (Swal.fire({
        title: 'Ya tiene Habitaciones cargadas. Desea Continuar con su Camión?',
        showDenyButton: true,
    ...
    if (locacion.tipo == "Baño" && !(bañosJson === null) && baños.length == 0){
        ...
        (Swal.fire({
            title: 'Ya tiene Baños cargados. Desea Continuar con su Camión?',
            showDenyButton: true,
            confirmButtonText: 'OK!',
            denyButtonText: `No, volver a cargar mi Camión`,
          }).then((result) => {
...
function CalculoBaño(locacion){
    ...
    divBaño.innerHTML =`
    <h3>Ingrese la cantidad de metros cuadrados para el Baño n°${nuevoBaño.nombre} : <input type="number" min="1" pattern="^[0-9]+" id='m2'/>m2<h3>`;
...
function CalculoCocina(locacion){
    ...
    divCocina.innerHTML =`
    <h3>Ingrese la cantidad de metros cuadrados para la Cocina n°: <input type="number" pattern="^[0-9]+" id='m2'/>m2<h3>`;
